...
public class CoffeOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coffe_order);
        findView();
        setListener();
    }
    ...
    private void setListener(){
        ...
        btnMakeOrder.setOnClickListener(view->{
            ...
            AlertDialog.Builder totalPrice = new AlertDialog.Builder(CoffeOrderActivity.this);
